...
/**
 * PBKDF2_SHA256加密验证算法 * * @author 慌途L
 */
public class Pbkdf2Sha256 {
    ...
    /**
     * 获取密文 * @param password 密码明文 * @param salt 加盐 * @param iterations 迭代次数 * @return
     */
...
// return new String(hashBase64);
    ...
    /**
     * 十六进制字符串转二进制字符串 * @param hex 十六进制字符串 * @return
     */
    ...
    /**
     * 二进制字符串转十六进制字符串 * @param array 二进制数组 * @return
     */
    ...
    /**
     * 密文加盐 (获取‘SALT_BYTE_SIZE’长度的盐值) * @return
     */
    ...
    /**
     * 获取密文 * 默认迭代次数：2000 * @param password 明文密码 * @return
     */
    ...
    /**
     * 获取密文 * @param password 明文密码 * @param iterations 迭代次数 * @return
     */
    ...
    /**
     * 获取密文 * 默认迭代次数：2000 * @param password 明文密码 * @param salt 盐值 * @return
     */
    ...
    /**
     * 最终返回的整串密文 * * 注：此方法返回密文字符串组成：算法名称+迭代次数+盐值+密文 * 不需要的直接用getEncodedHash方法返回的密文 * * @param password 密码明文 * @param salt 加盐 * @param iterations 迭代次数 * @return
     */
    ...
    /**
     * 验证密码 * @param password 明文 * @param hashedPassword 密文 * @return
     */
